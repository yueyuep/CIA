...
public class MutantBuilder {
    protected void _init(org.apache.ant.builder.BuildHelper helper) {
    ...
    protected void buildsetup(org.apache.ant.builder.BuildHelper helper) {
        helper.mkdir("${bin.dir}");
        helper.mkdir("${distlib.dir}");
        helper.copyFileset("${lib.dir}/parser", "${distlib.dir}/parser");
    }

    protected void init(org.apache.ant.builder.BuildHelper helper) {
        helper.mkdir("${bin.dir}/init");
        helper.javac("${java.dir}/init", "${bin.dir}/init", null);
        helper.jar("${bin.dir}/init", "${distlib.dir}/init.jar", null, null, null, null);
    }

    protected void common(org.apache.ant.builder.BuildHelper helper) {
        helper.mkdir("${bin.dir}/common");
        helper.mkdir("${distlib.dir}/common");
        helper.javac("${java.dir}/common", "${bin.dir}/common", "classpath.common");
        helper.jar("${bin.dir}/common", "${distlib.dir}/common/common.jar", null, null, null, null);
    }

    protected void antcore(org.apache.ant.builder.BuildHelper helper) {
        ...
        helper.jar("${bin.dir}/antcore", "${distlib.dir}/antcore/antcore.jar", null, null, null, null);
    }

    protected void frontend(org.apache.ant.builder.BuildHelper helper) {
        ...
        helper.jar("${bin.dir}/frontend", "${distlib.dir}/frontend/frontend.jar", null, null, null, null);
        helper.jar("${bin.dir}/frontend", "${distlib.dir}/frontend/cli.jar", null, null, "frontend.jar", "org.apache.ant.cli.Commandline");
    }

    protected void start(org.apache.ant.builder.BuildHelper helper) {
        helper.mkdir("${bin.dir}/start");
        helper.javac("${java.dir}/start", "${bin.dir}/start", "classpath.start");
        helper.jar("${bin.dir}/start", "${distlib.dir}/start.jar", null, null, "init.jar", "org.apache.ant.start.Main");
        helper.jar("${bin.dir}/start", "${distlib.dir}/ant.jar", null, null, "start.jar", "org.apache.tools.ant.Main");
    }

    protected void ant1compat(org.apache.ant.builder.BuildHelper helper) {
    }

    protected void remote(org.apache.ant.builder.BuildHelper helper) {
        helper.mkdir("${bin.dir}/remote");
        helper.javac("${java.dir}/remote", "${bin.dir}/remote", "classpath.start");
        helper.jar("${bin.dir}/remote", "${distlib.dir}/remote.jar", null, null, null, "org.apache.ant.remote.RemoteMain");
    }

    protected void clean(org.apache.ant.builder.BuildHelper helper) {
    }

    protected void antlibs(org.apache.ant.builder.BuildHelper helper) {
    }

    protected void systemlib(org.apache.ant.builder.BuildHelper helper) {
        ...
        helper.jar("${bin.dir}/antlibs/system", "${distlib.dir}/syslibs/system.jar", "${java.dir}/antlibs/system", "antlib.xml", null, null);
    }

    protected void main(org.apache.ant.builder.BuildHelper helper) {
    }

    protected void checkstyle(org.apache.ant.builder.BuildHelper helper) {
        helper.mkdir("${bin.dir}/check");
    }

    protected void javadocs(org.apache.ant.builder.BuildHelper helper) {
