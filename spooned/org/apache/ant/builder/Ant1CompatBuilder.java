...
public class Ant1CompatBuilder {
    ...
    protected void check_for_optional_packages(org.apache.ant.builder.BuildHelper helper) {
    }
    ...
    protected void ant1compat(org.apache.ant.builder.BuildHelper helper) {
        ...
        helper.jar("${bin.dir}/ant1compat", "${distlib.dir}/antlibs/ant1compat.jar", "${java.dir}/antlibs/ant1compat", "antlib.xml", null, null);
    }
